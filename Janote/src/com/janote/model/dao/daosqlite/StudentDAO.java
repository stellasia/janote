...
/**
 * The student DAO. Manage the Students table and link to the Student java
 * objects.
 * 
 * NB: the average grade is not a column of the Students table, it is computed
 * *on the fly*.
 * 
...
public class StudentDAO extends DAO<Student> {
        ...
        if (obj.getExamsGrades() != null) {
            ...
            while (it.hasNext()) {
                ...
                try {
                    ...
                    // prepare.setInt(1, obj.getID()); // no, do not set the ID,
    ...
    public boolean update(Student obj) {
        if (obj.getId() == null)
            throw new IllegalArgumentException("Object id is null; student ("
                    + obj.toString() + ") may already exist");
        try {

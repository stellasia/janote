 ...
 * http://balusc.blogspot.co.at/2008/07/dao-tutorial-data-layer.html)
 * 
...
public abstract class DAO<T> {
    ...
    /**
     * Add a bunch of new objects. Can eventually specify a `to`argument to add
     * obj to another one with an ID.
     * 
     * @param objs
     * @param to_id
     * @return
     ...
     * 
     * @param obj
     * @return boolean (True if successful) Especially, if the object does not
     *         exist in the DB, returns false.
     */

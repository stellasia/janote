...
/**
 * Class to describe a student.
 * Members:
 * 		- id
 * 		- name
 * 		- surname
 * 		- gender (Boy or Girl, @see Gender)
 * 		- email
 * 		- birthday (Date with format YYY-MM-DD)
 * 		- repeating (boolean)
 *      - groupID (the group the student belongs to)
 * 		
...
public class Student {
	 ...
	 * 
	 * If the name parameter is not valid (null or empty String or single space String), 
	 * throws a IllegalArgumentExcption. 
	 * 
	...
	public void setName(String name) {
		if (name != null && name != "" && name != " ") {
			...
			throw new IllegalArgumentException("Le nom d'un étudiant doit être rempli !");
	}
	/**
	...
	/**
	 * Set the birthday date from a String with format "dd-MM-YYYY". 
	 * If format is incorrect, Student.birthday will not be changed. 
	 * If paramter is null, birthday will be set to null. 
	 * 
	...
	/**
	 * @param repeating : true if the Student is repeating the same class.
	 */
	public void setRepeating(Boolean repeating) {
		this.repeating = repeating;
	}
	/**
	 * @param average_grade the average_grade to set
	 */
	...
	public String toString() {
		...
		return "Student [id=" + id + ", name=" + name + ", surname=" + surname
				...
				+ birthday + ", repeating=" + repeating 
				+ ", average_grade=" + average_grade + ", exams="

...
public class QuickTests {
    ...
    /**
     * A function to get the a filename from the standard input. A '.sql'
     * extension is added automatically if not entered by the user.
     * 
    ...
    public AbsDAOFactory get_connection() {
        ...
        if (filename != null) {
            ...
            try {
                adf = (DAOFactorySQLite) AbsDAOFactory.getFactory(
                        AbsDAOFactory.SQLITE_DAO_FACTORY, filename);
            }
            catch (Exception e) {
    ...
    public void test_students(StudentDAO dao) {
        ...
        Student s1 = null;
        s1 = new Student(1, "Ford", "Peter", Gender.BOY, "pford@somewhere.com",
                "11-01-1999", false, null);
    ...
    public void test_groups(GroupDAO dao) {
        Student s1 = new Student(null, "Ford", "Shanon", Gender.GIRL,
                "sford@somewhere.com", "11-01-1999", false, null);
        Student s2 = new Student(null, "Thomson", "John", Gender.BOY,
                "j.thomson@elsewhere.com", "14-11-1998", false, null);
        Student s3 = new Student(null, "Smith", "Albert", Gender.BOY,
                "albert.smith@usa.com", "21-06-1997", true, null);
        Student s4 = new Student(null, "Alabama", "Anna", Gender.GIRL,
                "aaaa@lala.com", "07-02-1999", true, null);
        ...
        Group g1 = new Group(null, "G1",
                "Ceci est la description du groupe 1. Par exemple : '1èreS 1'",
                list1, null);
        System.out.println(g1);
        dao.add(g1);

        /*
         * for (Student s:list1) { if (dao.addStudent(s, g1))
         * System.out.println("Student successfully added"); else
        ...
        Group g2 = new Group(null, "G2",
                "Ceci est la description du groupe 2. Par exemple : 'TS 13'",
                list2, null);
        System.out.println(g2);
        dao.add(g2);
        /*
         * for (Student s:list2) { if (dao.addStudent(s, g2))
         * System.out.println("Student successfully added"); else
         * System.out.println("Failed to add student to db"); }
         */
    ...
    public void run() {
        ...
        /*
         * GroupDAO gdao = (GroupDAO) adf.getGroupDAO(); this.test_groups(gdao);
         */
        ...
        ArrayList<Group> grs = gdao.findAll();
